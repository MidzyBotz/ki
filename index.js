/**
   * Create By Kiki.
   * Contact Me on wa.me/6289653430712
   * Follow https://github.com/MidzyBotz
*/

require('./config')
const { default: jobotzConnect, useSingleFileAuthState, DisconnectReason, fetchLatestBaileysVersion, generateForwardMessageContent, prepareWAMessageMedia, generateWAMessageFromContent, generateMessageID, downloadContentFromMessage, makeInMemoryStore, jidDecode, proto } = require("@adiwajshing/baileys")
...
async function startjobotz() {
    const jobotz = jobotzConnect({
        logger: pino({ level: 'silent' }),
        printQRInTerminal: true,
        browser: ['❴ ㅊ ❈ Sana BOT ✯ By ♂🎉 KIKI ORIㅊ ❈ ❵ MD', 'Safari','1.0.0'],
        auth: state
    })
    ...
    jobotz.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                if (anu.action == 'add') {
                  jobotz.sendMessage(anu.id, { image: { url: pp_user }, contextInfo: { mentionedJid: [num] }, caption: `╭━═════════════━• \n│〘Halo Saudara ku @${num.split("@")[0]}〙\n╰━═════════════━• \n╭━═════════════━• \n│⭔ Welcome To\n│⭔ ${metadata.subject}\nSilahkan Intro\nNama:\nUmur:\nKelas:\nAsalKota:\nTujuan ke sini:\n╰━═════════════━• \n╭━═════════════━• \n│⭔ ❴ ㅊ ❈ Sana BOT ✯ By ♂🎉 KIKI ORIㅊ ❈ ❵\n│⭔JANGAN LUPA FOLLOW https://instagram.com/kiki_notrobot\n╰━═════════════━• \n •━══〘❈ By ♂🎉 KIKI ORI ❈〙══━•` })
                    
                } else if (anu.action == 'remove') {
                  jobotz.sendMessage(anu.id, { image: { url: pp_user }, contextInfo: { mentionedJid: [num] }, caption: `╭━═════════════━• \n│〘Bye BOCAH BEBAN @${num.split("@")[0]}〙 \n╰━═════════════━• \n╭━═════════════━• \n│⭔ Leaving From\n│⭔ ${metadata.subject}\n╰━═════════════━• \n╭━═════════════━• \n│⭔ ❴ ㅊ ❈ Sana BOT ✯ By ♂🎉 KIKI ORIㅊ ❈ ❵\n│⭔ JANGAN LUPA FOLLOW https://instagram.com/kiki_notrobot\n╰━═════════════━• \n •━══〘❈ By ♂🎉 KIKI ORI ❈〙══━•` })
